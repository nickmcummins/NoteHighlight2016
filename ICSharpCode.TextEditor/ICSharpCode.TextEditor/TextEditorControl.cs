	...
	private float MeasurePrintingHeight(Graphics g, LineSegment line, float maxWidth)
	{
		...
		foreach (TextWord word in line.Words)
		{
			...
			case TextWordType.Tab:
				Advance(ref num, ref num2, maxWidth, checked(base.TabIndent * primaryTextArea.TextArea.TextView.WideSpaceWidth), num3);
				break;
	...
	private void DrawLine(Graphics g, LineSegment line, float yPos, RectangleF margin)
	{
		...
		foreach (TextWord word in line.Words)
		{
			...
			case TextWordType.Space:
				...
				break;
			case TextWordType.Tab:
				Advance(ref num, ref yPos, margin.Width, checked(base.TabIndent * primaryTextArea.TextArea.TextView.WideSpaceWidth), num2);
				break;
			case TextWordType.Word:
			{
