...
public class CodeCompletionWindow : AbstractCompletionWindow
{
	...
	private void SetDeclarationViewLocation()
	{
		checked
		{
			...
			Point point = ((num2 * 2 <= num) ? new Point(base.Bounds.Left - declarationViewWindow.Width, base.Bounds.Top) : new Point(base.Bounds.Right, base.Bounds.Top));
	...
	protected override void CaretOffsetChanged(object sender, EventArgs e)
	{
		...
		{
			codeCompletionListView.SelectItemWithStart(control.Document.GetText(startOffset, checked(offset - startOffset)));
		}
	}
	...
	protected override bool ProcessTextAreaKey(Keys keyData)
	{
		...
		case Keys.Home:
			...
			return true;
		case Keys.End:
			codeCompletionListView.SelectIndex(checked(completionData.Length - 1));
			return true;
		case Keys.Next:
